...
<body>
   ...
   <form  name="myform" onsubmit="return validationform()" method="post">
    <fieldset class="item2">
        ...
        Name: <input class="item" type="text" name="fname"/><br/>
        <br/>
        ...
        <br/>
        <br/>
        Contact NO: <input   class="item"type="text" name="fphone"/>
        <br/>
        <br/>
     ...
     <h4><a href="online payment.html">for online payment click here</a></h4> <input  class="button" type="submit" value="form submission">
...
<script>
  ...
  Element.getElementsbyclassname('form error')[0].inner html=error

    }
    function validationform(){
        varreturn=true;
        varname=document.forms['my form']["fname"]. value;
        if(namelength<5){
            seterror("name","length of name is to short");
          
        }
        varname=document.forms['my form']["fphone"]. value;
        if(phonelength<5){
            seterror("name","con tact no have  at least 11 digits");
